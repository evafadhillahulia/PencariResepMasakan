...
data1 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-ayam.csv').dropna()
data2 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-ikan.csv').dropna()
data3 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-kambing.csv').dropna()
data4 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-sapi.csv').dropna()
data5 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-tahu.csv').dropna()
data6 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-telur.csv').dropna()
data7 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-tempe.csv').dropna()
data8 = pd.read_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/dataset-udang.csv').dropna()
...
data.to_csv('/Users/eva/Desktop/Project Aplikasi/PencariResepMasakan/data_praproses.csv', index=False)